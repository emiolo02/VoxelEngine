...
1, 3, 10,
	...
	void RenderMesh(DrawCmd* cmd)
	{
		...
		UniformMat4("projView", Camera::GetCamera(CAMERA_MAIN)->projView, meshProgram);
		UniformMat4("model", boxCmd->transform, meshProgram);
		UniformVec4("color", boxCmd->color, meshProgram);
